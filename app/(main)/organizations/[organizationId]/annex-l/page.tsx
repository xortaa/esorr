...
export default function AnnexLManager({ params }: { params: { organizationId: string } }) {
  ...
  const fetchAnnexes = async () => {
    try {
      const response = await axios.get(`/api/annexes/${params.organizationId}/annex-l`);
  ...
  const submitAnnexForReview = async (id: string) => {
    try {
      const response = await axios.patch(`/api/annexes/${params.organizationId}/annex-l/${id}`, {
        isSubmitted: true,
      });
