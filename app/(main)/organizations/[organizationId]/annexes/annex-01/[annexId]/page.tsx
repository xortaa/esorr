...
export default function AoAManager() {
  ...
  return (
    <PageWrapper>
      ...
      <button onClick={createNewAoA} className="btn btn-primary mb-6">
        <Plus className="mr-2 h-4 w-4" /> Create New Articles of Association
      </button>
            ...
            <div className="card-body">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <h2 className="card-title">Articles of Association for Year {aoa.year}</h2>
                </div>
      ...
      {aoaList.length === 0 && (
        <div className="text-center text-gray-500 mt-8">
          <p>No Articles of Association created yet.</p>
