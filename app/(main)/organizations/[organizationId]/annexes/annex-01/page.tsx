  ...
  return (
    <PageWrapper>
      <h1 className="text-2xl font-bold mb-6">
        Annex 01 The Rules of Procedure for Recognition of Student Organizations Annex Manager
      </h1>
      <button onClick={createNewAnnex} className="btn btn-primary mb-6">
        <Plus className="mr-2 h-4 w-4" />
        Create The Rules of Procedure for Recognition of Student Organizations Annex
      </button>
            ...
            <div className="card-body">
              <div className="flex items-center justify-between">
                <h2 className="card-title">
                  The Rules of Procedure for Recognition of Student Organizations Annex for Year {annex.year}
                </h2>
      ...
      {annexList.length === 0 && (
        <div className="text-center text-gray-500 mt-8">
          <p>No The Rules of Procedure for Recognition of Student Organizations Annex created yet.</p>
