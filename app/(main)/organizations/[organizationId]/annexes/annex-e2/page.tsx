...
export default function AnnexEManager() {
  ...
  return (
    <PageWrapper>
      <h1 className="text-2xl font-bold mb-6">Annex E-2 Financial Report Liquidation Report Annex Manager</h1>
      <button onClick={createNewAnnex} className="btn btn-primary mb-6">
        <Plus className="mr-2 h-4 w-4" /> Create New Financial Report Liquidation Report Annex
      </button>
          ...
          <div key={annex.id} className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <div className="flex items-center justify-between">
                <h2 className="card-title">Financial Report Liquidation Report Annex for Year {annex.year}</h2>
