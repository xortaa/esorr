...
export default function AnnexIManager() {
  ...
  return (
    <PageWrapper>
      <h1 className="text-2xl font-bold mb-6">Annex I Commitment To Responsible Use of Social Media Manager</h1>
      <button onClick={createNewAnnex} className="btn btn-primary mb-6">
        <Plus className="mr-2 h-4 w-4" />
        Create New Commitment To Responsible Use of Social Media Annex
      </button>
