    ...
    <Document>
     <Page style={styles.page} size="LEGAL" orientation="portrait">
        ...
        <View style={styles.tablelegend}>
            ...
            <View style={styles.tableRow}>
              ...
              <Text style={[styles.tableCell, {}]}>
                <Text style={{ fontSize: 11, textAlign: "left" }}>
                  RSO stands for Recognized Student Organization
                </Text>
              </Text>
            </View>
        ...
        <View style={styles.tablelist}>
          ...
          >
                WHEREFORE, the petition for recognition of eight (8) student organizations listed under Group
                A, pursuant to the provisions of the Rules and Procedures for Recognition of Student
                Organizations, is hereby granted FULL ACCREDITATION for 3 years. The petition for
                recognition of one hundred twenty-six (126) student organizations listed under Group B is
                hereby granted FULL ACCREDITATION for 2 years; the petition for recognition of
                twenty-one (21) student organizations listed under Group C is hereby granted Probationary for
                1 year. {"\n"}
                WHEREFORE, the petitioning New Organizations listed under Group C is hereby granted
                Probationary for 1 year.{"\n"}
                WHEREFORE, all recognized student organizations, pursuant to the provisions in the Rules and
                Procedures for Recognition of Student Organizations, must comply with the Implementing Rules
                and Regulations for Accreditation status of the Office for Student Affairs (Annex A).{"\n"}
                So Ordered.{"\n"}
                30 September 2024
...
const App = () => (
  <div>
    <h1>PDF GENERATOR EXAMPLE RESO</h1>
