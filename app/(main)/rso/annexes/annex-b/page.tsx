...
export default function AnnexBManager() {
  ...
  const editAoA = (id: string) => {
    ...
    router.push(`/rso/annexes/annex-b/${id}`);
  };

  return (
    <PageWrapper>
      <h1 className="text-2xl font-bold mb-6">Annex B List Of Members Manager</h1>
      <button onClick={createNewAoA} className="btn btn-primary mb-6">
        <Plus className="mr-2 h-4 w-4" />
        Create New List Of Members Annex
      </button>
            ...
            <div className="card-body">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <h2 className="card-title">List Of Members Annex for Year {aoa.year}</h2>
                </div>
