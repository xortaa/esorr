...
export default function AnnexEManager() {
  ...
  const editAnnex = (id: string) => {
    ...
    router.push(`/rso/annexes/annex-e1/${id}`);
  };
  ...
  return (
    <PageWrapper>
      ...
      <button onClick={createNewAnnex} className="btn btn-primary mb-6">
        <Plus className="mr-2 h-4 w-4" /> Create New Financial Report Summary of Receipts and Disbursements
      </button>
            ...
            <div className="card-body">
              <div className="flex items-center justify-between">
                <h2 className="card-title">
                  Financial Report Summary of Receipts and Disbursements for Year {annex.year}
                </h2>
      ...
      {annexList.length === 0 && (
        <div className="text-center text-gray-500 mt-8">
          <p>No Financial Report Summary of Receipts and Disbursements created yet.</p>
