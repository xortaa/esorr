...
export default function AnnexFManager() {
  ...
  const editAnnex = (id: string) => {
    ...
    router.push(`/rso/annexes/annex-g/${id}`);
  };

  return (
    <PageWrapper>
      <h1 className="text-2xl font-bold mb-6">Annex G Organization Adviser Nomination Form Annex Manager</h1>
      <button onClick={createNewAnnex} className="btn btn-primary mb-6">
        <Plus className="mr-2 h-4 w-4" />
        Create New Annex G Organization Adviser Nomination Form Annex
      </button>
          ...
          <div key={annex.id} className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <div className="flex items-center justify-between">
                <h2 className="card-title">Annex G Organization Adviser Nomination Form Annex for Year {annex.year}</h2>
      ...
      {annexList.length === 0 && (
        <div className="text-center text-gray-500 mt-8">
          <p>No Annex G Organization Adviser Nomination Form Annex created yet.</p>
